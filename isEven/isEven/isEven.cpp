...
//   1. First step: Apply the Team's policy and open the menu
...
//   6. Last step is to deploy the program on this system, which is set up accordingly. Please follow the instructions > no actions required at the moment
