...
//   3. Use the first window to see a various options for adjusting the interface xxx xxx 
//   4. Use the Error List window to view xxx
//   5. Go to Project > Add New Item to create new files and folders, or Project > Add Existing Item to add existing code xxx xxx xxx xxx
